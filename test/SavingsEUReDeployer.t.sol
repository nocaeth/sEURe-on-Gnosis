...
contract SavingsEUReDeployerTest is Test {
    ...
    function _assertRunSeedsSavingsEuRe(uint256 deployerPrivateKey) internal {
        ...
        SavingsEURe savingsEURe = SavingsEURe(expectedSavingsEURe);
        ...
        assertEq(address(interestDispatcher.sEURe()), address(savingsEURe));
        ...
        assertGe(interestDispatcher.currentEpochBalance(), interestDispatcher.MIN_EPOCH_BALANCE());
    }
